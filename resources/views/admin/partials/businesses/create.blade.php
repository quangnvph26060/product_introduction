...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Tạo doanh nghiệp </h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('businesses.index') }}">Doanh nghiệp</a></li>
                                <li class="breadcrumb-item active">Tạo doanh nghiệp</li>
                            </ol>
                        </div>
            ...
            <form id="businesses-form" autocomplete="off" method="POST" action="{{ route('businesses.store') }}"
