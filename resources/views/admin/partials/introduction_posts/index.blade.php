                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('introduction_posts.create') }}" class="btn btn-primary btn-sm">Thêm mới sản phẩm (+)</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="product-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%; text-align: center">Danh mục giới thiệu</th>
                                ...
                                <tbody>
                                    @foreach ($introductionPosts as $item)
                                        <tr>
                                            ...
                                            <td>{{ \Str::limit(strip_tags(html_entity_decode($item->content)), 100) }} </td>
                                            <td>
                                                <div class="d-flex gap-3 justify-content-center">
                                                    <a href="{{ route('introduction_posts.edit', $item->id) }}" class="btn btn-primary " >
                                                        <i class="fa-regular fa-pen-to-square"></i>
                                                    </a>
                                                    <form action="{{ route('introduction_posts.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Bạn có muốn xóa ?')">
                                                        @csrf
                                                        @method('DELETE')
