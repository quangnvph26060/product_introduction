...
<style>
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form id="createproduct-form" action="{{ route('post.store') }}" autocomplete="off" method="POST" class="needs-validation" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    <h5 class="fs-14 mb-1">Hình ảnh bài viết</h5>
                                    {{-- <p class="text-muted">Hình ảnh bài viết.</p> --}}
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            <div class="position-absolute top-100 start-100 translate-middle">
                                                ...
                                                <input class="form-control d-none" name="image" id="product-image-input"
