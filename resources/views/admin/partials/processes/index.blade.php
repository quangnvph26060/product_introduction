            ...
            <div class="">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title">Quy trình</h4>
                        <div class="card-tools">
                            {{-- <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                Import
                            </button> --}}
                            <a href="{{ route('process.create') }}" class="btn btn-primary btn-sm">Thêm mới (+)</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="product-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $process->title }}</td>
                                        <td><img src="{{ asset($process->image) }}" width="50" height="50"
                                                alt="{{ $process->title }}"></td>
                                        <td><img src="{{ asset($process->icon) }}" width="50" height="50"
                                                alt="{{ $process->title }}"></td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-3 justify-content-center">
                                                ...
                                                <form action="{{ route('process.destroy', $process->id) }}" method="POST" onsubmit="return confirm('Bạn có muốn xóa không ?')">
                                                    @csrf
                                                    @method('DELETE')
